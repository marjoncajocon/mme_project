...
set SRC=mme.c ejson.c econfig.c elsp.c etheme.c ebuf.c eterm.c edraw.c emenu.c eside.c esearch.c egit.c esyntax.c epanel.c ekeys.c esnip.c eext.c egitlog.c equick.c eregex.c esettings.c ewelcome.c efiles.c eemmet.c edebug.c etask.c eout.c ehistory.c emd.c eworkspace.c eimport.c evscode.c etest.c eonig.c etm.c %TSRC% %BASE%
