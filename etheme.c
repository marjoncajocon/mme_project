...
static const uint32_t dark_plus[C_N] = {
  ...
  [C_INLAY_FG] = 0x969696, [C_INLAY_BG] = 0x2A2A2A, [C_LENS] = 0x999999,
...
static const Color light_plus[] = {
  ...
  {C_INLAY_FG, 0x969696}, {C_INLAY_BG, 0xF0F0F0}, {C_LENS, 0x919191},
...
static const Color monokai[] = {
  ...
  {C_INLAY_FG, 0x90908A}, {C_INLAY_BG, 0x32332C}, {C_LENS, 0x90908A},
...
static const Color solarized[] = {
  ...
  {C_INLAY_FG, 0x657B83}, {C_INLAY_BG, 0x073642}, {C_LENS, 0x657B83},
