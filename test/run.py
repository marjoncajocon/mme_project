...
SCENARIOS = [
    ...
    Scen("notebook-open", "lang/nb.ipynb",
         ["w:1200", "d"],
         "a .ipynb opens in the notebook editor: the toolbar, Markdown drawn, code colored, [n], the saved outputs"),
    Scen("notebook-edit-cell", "lang/nb.ipynb",
         ["w:1200", "k:`[B", "k:`[B", "k:\r", "k:`[F", "k: + 1", "w:400", "d", "k:\x1b", "k:b", "k:y = 2", "w:400", "d"],
         "Down selects the next cell, Enter edits it, typing goes in; Esc, B adds a cell under it in edit mode"),
    Scen("notebook-new", "lang/edit.c",
         ["w:900", "k:" + CTRL_SHIFT_P, "w:300", "k:create: new jupyter", "w:500", "k:\r", "w:700", "k:x = 1", "w:400", "d"],
         "Create: New Jupyter Notebook opens Untitled-1.ipynb, the caret in its first cell"),
    Scen("palette-ctrl-v", "lang/edit.c",
         ["w:900", "k:" + CTRL_C, "w:200", "k:" + CTRL_SHIFT_P, "w:300", "k:" + CTRL_V, "w:700", "d"],
         "Ctrl+V pastes the clipboard into the palette's box (the line Ctrl+C copied, up to its end)"),
    Scen("find-ctrl-v", "lang/edit.c",
         ["w:900", "k:" + CTRL_C, "w:200", "k:" + CTRL_F, "w:300", "k:" + CTRL_V, "w:700", "d"],
         "Ctrl+V pastes the clipboard into the find box"),
    Scen("gotofile", "proj",
